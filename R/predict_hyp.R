...
#' 
#' @aliases predict_hyp predict_hyp.default predict_hyp.character predict_hyp.data.frame predict_hyp.list predict_hyp.AAStringSet
...
#' @rdname predict_hyp
#' @method predict_hyp AAStringSet
#' @export

predict_hyp.AAStringSet <-  function(data,
                                     ...){
