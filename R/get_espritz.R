...
#'
#' @source \url{http://old.protein.bio.unipd.it/espritz/}
...
get_espritz.default <- function(data = NULL,
  ...
  url_query <- "http://old.protein.bio.unipd.it/espritz/Espritz.jsp"
  url_2 <- "http://old.protein.bio.unipd.it/espritz/work/pid_"
